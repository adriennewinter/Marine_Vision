...
// int m, n, o = 0; 
// int i, j, k, l = 1;
// std::deque<synched_struct> synch_1_buffer, synch_2_buffer; // a deque of structs
...
//               o++;
//             }
//             imuBuffer.pop_front(); // remove the IMU message that is the same as the synch_2_buffer so we don't add it to the rosbag twice
