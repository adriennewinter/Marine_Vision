...
#include <sensor_msgs/CompressedImage.h> // camera image messages
...
//-------------------------CALLBACKS-------------------------------------------------------
void SynchCallback(const sensor_msgs::CompressedImage::ConstPtr& img0_synch_msg, const sensor_msgs::CompressedImage::ConstPtr& img1_synch_msg, const sensor_msgs::Imu::ConstPtr& imu_synch_msg)
...
{
  sensor_msgs::CompressedImage img0_synch_msg, img1_synch_msg;
...
// Load rosbag, iterate through the messages on each topic and call the synchronizer callback
{
  ...
  typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::CompressedImage, sensor_msgs::CompressedImage, sensor_msgs::Imu> approxTimePolicy;
  //ros::Duration maxInterval = ros::Duration(0.5,0); // (seconds, nanoseconds)
  //message_filters::sync_policies::ApproximateTime<sensor_msgs::CompressedImage, sensor_msgs::CompressedImage, sensor_msgs::Imu>::setMaxIntervalDuration(maxInterval); // set maximum synchronization timestamp difference 
